...
function Blogpost() {
  return (
    <>
      <Helmet>
        <title>Barrel Leg Jeans & How To Wear Them</title>
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Barrel Leg Jeans & How To Wear Them"
        />
        <meta
          property="og:description"
          content="I’m not cool when it comes to fashion. I rarely take risks with my
        ...
        <meta
          property="og:url"
          content="https://xyztestblog.vercel.app/p/a5280e7407a153d9622a02a8ef58d6fd"
        />
      </Helmet>
        ...
        <article className="blog__post">
          ...
          <div className="blog__post--content">
            ...
            <p>
              ...
              disappointing myself since I had a feeling they’d be overwhelming
              on me – so I didn’t try them out.
            </p>
            <p>
              ...
              volume to the lower body, but also stays cinched at the waist.
            ...
            <p>
              ...
              distressing was pretty interesting. I had to get them for
              important research;) I really love them. I think they’re a cool
              jean to have in your closet, and they’re at an amazing price!
            </p>
            <img
              src={
            ...
            />
            <p>
              This pair was the one that got me into barrel jeans. They’re
              almost *too* subtle, but in the best way possible…you know? I
              tried on three different sizes, and going one size down from my
              typical denim size ended up looking the best on me!
            </p>
            <p>
              At the end of the day, I’m always looking for pieces that make me
              feel effortlessly cool. And that’s how barrel jeans makes me
              feel!!
            </p>
          </div>
        </article>
